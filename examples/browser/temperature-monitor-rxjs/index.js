...
// See: aws-iot-device-sdk-js/watch-and-build-temperature-browser-client-rxjs.sh
...
const $deltas = Rx.Observable.fromEvent(
  shadows, 'delta', (name, stateObject) => ({name, stateObject}))

$deltas.subscribe(
  ({name, stateObject}) => {
    console.log('delta data', name, stateObject)
...
const $status = Rx.Observable.fromEvent(
  shadows, 'status', (name, statusType, clientToken, stateObject) => ({name, statusType, clientToken, stateObject}))

$status.subscribe(
  ({name, statusType, clientToken, stateObject}) => {
    console.log('status data', name, statusType, clientToken, stateObject)
